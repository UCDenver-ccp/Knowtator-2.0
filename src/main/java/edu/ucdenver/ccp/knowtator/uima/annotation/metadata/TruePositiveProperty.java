...
/**
 * Indicates this annotation was scored as a True Positive during an evaluation. Updated by JCasGen
...
public class TruePositiveProperty extends TestSetProperty {
  ...
  public static final String _TypeName =
      "edu.ucdenver.ccp.knowtator.uima.annotation.metadata.TruePositiveProperty";
   ...
   */
  @SuppressWarnings("hiding")
  public static final int typeIndexID = JCasRegistry.register(TruePositiveProperty.class);
  /**
   * The constant type.
   *
   * @generated
   ...
   * @generated
   */
  protected TruePositiveProperty() {
  ...
  /**
   * Instantiates a new True positive property.
   *
