...
public class CCPDoubleSlotMention extends CCPPrimitiveSlotMention {
  ...
  public static final String _TypeName =
      "edu.ucdenver.ccp.knowtator.uima.mention.CCPDoubleSlotMention";
   ...
   */
  @SuppressWarnings("hiding")
  public static final int typeIndexID = JCasRegistry.register(CCPDoubleSlotMention.class);
  /**
   * The constant type.
   *
   * @generated
  ...
  private static final CallSite _FC_slotValues =
      TypeSystemImpl.createCallSite(CCPDoubleSlotMention.class, "slotValues");
   ...
   * @generated
   */
  protected CCPDoubleSlotMention() {
  ...
  /**
   * Instantiates a new Ccp double slot mention.
   *
  ...
  public DoubleArray getSlotValues() {
    return (DoubleArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_slotValues)));
  }
