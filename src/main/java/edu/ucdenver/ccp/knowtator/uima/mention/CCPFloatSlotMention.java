...
public class CCPFloatSlotMention extends CCPPrimitiveSlotMention {
  ...
  public static final String _TypeName =
      "edu.ucdenver.ccp.knowtator.uima.mention.CCPFloatSlotMention";
   ...
   */
  @SuppressWarnings("hiding")
  public static final int typeIndexID = JCasRegistry.register(CCPFloatSlotMention.class);
  /**
   * The constant type.
   *
   * @generated
  ...
  private static final CallSite _FC_slotValues =
      TypeSystemImpl.createCallSite(CCPFloatSlotMention.class, "slotValues");
  ...
  /**
   * Instantiates a new Ccp float slot mention.
   *
  ...
  public FloatArray getSlotValues() {
    return (FloatArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_slotValues)));
  }
