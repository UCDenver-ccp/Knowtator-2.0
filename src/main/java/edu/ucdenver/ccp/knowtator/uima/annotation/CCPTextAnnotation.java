...
public class CCPTextAnnotation extends CCPAnnotation {
  ...
  public final static String _TypeName = "edu.ucdenver.ccp.knowtator.uima.annotation.CCPTextAnnotation";
  ...
  public final static String _FeatName_owlClass = "owlClass";
  ...
  private final static CallSite _FC_owlClass = TypeSystemImpl.createCallSite(CCPTextAnnotation.class, "owlClass");
  private final static MethodHandle _FH_owlClass = _FC_owlClass.dynamicInvoker();
