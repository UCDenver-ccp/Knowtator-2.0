...
public class CCPStringSlotMention extends CCPPrimitiveSlotMention {
  ...
  public static final String _TypeName =
      "edu.ucdenver.ccp.knowtator.uima.mention.CCPStringSlotMention";
   ...
   */
  @SuppressWarnings("hiding")
  public static final int typeIndexID = JCasRegistry.register(CCPStringSlotMention.class);
  /**
   * The constant type.
   *
   * @generated
  ...
  private static final CallSite _FC_slotValues =
      TypeSystemImpl.createCallSite(CCPStringSlotMention.class, "slotValues");
   ...
   * @generated
   */
  protected CCPStringSlotMention() {
  ...
  /**
   * Instantiates a new Ccp string slot mention.
   *
  ...
  public StringArray getSlotValues() {
    return (StringArray) (_getFeatureValueNc(wrapGetIntCatchException(_FH_slotValues)));
  }
