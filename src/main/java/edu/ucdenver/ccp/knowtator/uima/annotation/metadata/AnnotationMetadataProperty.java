...
/**
 * Superclass for annotation metadata properties Updated by JCasGen Fri Apr 06 16:53:14 MDT 2018 XML
 * source:
...
public class AnnotationMetadataProperty extends TOP {
  ...
  public static final String _TypeName =
      "edu.ucdenver.ccp.knowtator.uima.annotation.metadata.AnnotationMetadataProperty";
   ...
   */
  @SuppressWarnings("hiding")
  public static final int typeIndexID = JCasRegistry.register(AnnotationMetadataProperty.class);
  /**
   * The constant type.
   *
   * @generated
   ...
   * @generated
   */
  protected AnnotationMetadataProperty() {
  ...
  /**
   * Instantiates a new Annotation metadata property.
   *
