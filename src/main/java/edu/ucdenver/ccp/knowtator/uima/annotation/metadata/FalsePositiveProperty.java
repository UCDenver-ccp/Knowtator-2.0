...
/**
 * Indicates that an annotation was scored as a False Positive during an evaluation. Updated by
...
public class FalsePositiveProperty extends TestSetProperty {
  ...
  public static final String _TypeName =
      "edu.ucdenver.ccp.knowtator.uima.annotation.metadata.FalsePositiveProperty";
   ...
   */
  @SuppressWarnings("hiding")
  public static final int typeIndexID = JCasRegistry.register(FalsePositiveProperty.class);
  /**
   * The constant type.
   *
   * @generated
   ...
   * @generated
   */
  protected FalsePositiveProperty() {
  ...
  /**
   * Instantiates a new False positive property.
   *
