...
public class GraphView extends JPanel implements GraphSpaceSelectionListener, ProjectListener {
	...
	private void $$$setupUI$$$() {
		...
		previousGraphSpaceButton.setIcon(new ImageIcon(getClass().getResource("/icon/icons8-sort-up-filled-50.png")));
		...
		nextGraphSpaceButton.setIcon(new ImageIcon(getClass().getResource("/icon/icons8-sort-down-filled-50.png")));
