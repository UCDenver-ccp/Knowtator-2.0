...
public class GraphView extends JPanel implements GraphSpaceSelectionListener, ProjectListener {
  ...
  private void makeButtons() {
    ...
    minRadioButton.addActionListener(
        e -> {
          ...
          view.getController()
              .getSelectionManager()
              .setSelectedPropertyQuantifierValue(valueTextField.getText());
        });
    ...
    negateCheckBox.addActionListener(
        e ->
            view.getController()
                .getSelectionManager()
                .setNegateProperty(negateCheckBox.isSelected()));
  ...
  private void $$$setupUI$$$() {
    ...
    addAnnotationNodeButton.setIcon(
        new ImageIcon(getClass().getResource("/icon/icons8-plus-24.png")));
    ...
    this.$$$loadButtonText$$$(
        someRadioButton, ResourceBundle.getBundle("log4j").getString("some1"));
    propertyValuePanel.add(
        someRadioButton,
    ...
    this.$$$loadButtonText$$$(
        exactlyRadioButton, ResourceBundle.getBundle("log4j").getString("exactly1"));
    propertyValuePanel.add(
        exactlyRadioButton,
        new com.intellij.uiDesigner.core.GridConstraints(
            2,
