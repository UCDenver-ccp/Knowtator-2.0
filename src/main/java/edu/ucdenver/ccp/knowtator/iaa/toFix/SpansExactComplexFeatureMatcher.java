...
//	 * complex features. It is not required that the concept class match.
...
//		// {
//		// int result = concept.compareComplexFeature(concept,
//		// candidateAnnotation, );
//		// if there is a trivial_match then there cannot possibly be a
//		// NONTRIVIAL_MATCH
//		// because one of the simple features of the passed in concept must
//		// have a null value
