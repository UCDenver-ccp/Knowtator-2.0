...
public class TextSource implements Savable, KnowtatorObject {
  ...
  public void removeSelectedAnnotation() {
    Annotation annotationToRemove = annotationManager.getSelectedAnnotation();
    annotationManager.removeAnnotation(annotationToRemove);
    graphSpaceManager.removeAnnotation(annotationToRemove);
  }
