...
(reg-sub ::selected-review-type
  (fn [db _] (get-in db [:selection :review-type])))
...
(reg-sub ::review-filters
  (fn [db _] (vals (get-in db [:selection :review-filters]))))
...
(reg-sub ::selected-review-filter-type
  (fn [db _] (get-in db [:selection :review-filter-type])))

(reg-sub ::show-filters (fn [db _] (get-in db [:selection :show-filters])))
