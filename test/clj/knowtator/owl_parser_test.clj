...
(deftest parse-ontology-test
  (testing "Parse basic ontology"
      ...
      {:type :ontology
       ...
       [{:type :annotation
        ...
        {:type    :annotation
         ...
         :literal {:value "Alan Rector"
                   :type  :RDF_PLAIN_LITERAL}}
        {:type    :annotation
         :iri     "http://purl.org/dc/terms/contributor"
         :literal {:value "Chris Wroe"
                   :type  :RDF_PLAIN_LITERAL}}
        {:type    :annotation
         :iri     "http://purl.org/dc/terms/contributor"
         :literal {:value "Matthew Horridge"
                   :type  :RDF_PLAIN_LITERAL}}
        {:type    :annotation
         :iri     "http://purl.org/dc/terms/contributor"
         :literal {:value "Nick Drummond"
                   :type  :RDF_PLAIN_LITERAL}}
        {:type    :annotation
         :iri     "http://purl.org/dc/terms/contributor"
         :literal {:value "Robert Stevens"
                   :type  :RDF_PLAIN_LITERAL}}
        {:type    :annotation
         :iri     "http://purl.org/dc/terms/license"
         :literal {:value "Creative Commons Attribution 3.0 (CC BY 3.0)"
                   :type  :XSD_STRING}}
        {:type :annotation
   ...
   (testing "Assertion types"
    (t/are [_ iri f expected] (= expected
                                 (-> test-ontology
                                     (to/entity-for-iri (to/iri iri))
                                     (sut/into-map [:annotation :disjoint :super
                                                    :equivalent]
                                                   [:type])
                                     f))
      :some "http://www.co-ode.org/ontologies/pizza/pizza.owl#ParmaHamTopping"
      :super
      ...
      :and "http://www.co-ode.org/ontologies/pizza/pizza.owl#ThinAndCrispyPizza"
      :equivalent
      [{:type :and
        :data
      ...
      :not "http://www.co-ode.org/ontologies/pizza/pizza.owl#VegetarianPizza"
      :equivalent
      [{:type :and
        :data
        #{"http://www.co-ode.org/ontologies/pizza/pizza.owl#Pizza"
      ...
      :or "http://www.co-ode.org/ontologies/pizza/pizza.owl#VegetarianTopping"
      :equivalent
      [{:type :and
        :data
      ...
      [{:type :and
        ...
        #{"http://www.co-ode.org/ontologies/pizza/pizza.owl#Pizza"
          {:type :only
           ...
           #{"http://www.co-ode.org/ontologies/pizza/pizza.owl#hasBase"
             "http://www.co-ode.org/ontologies/pizza/pizza.owl#ThinAndCrispyBase"}}}}]
      :oneof "http://www.co-ode.org/ontologies/pizza/pizza.owl#Country"
      :equivalent
      [{:type :and
        :data
    ...
    (is
     (=
      ...
      (->> test-ontology-map
           :class-hierarchy
           (util/map-vals
            (comp (partial util/map-vals (comp set (partial take 4)))
                  (partial into {})
                  (partial take 4))))))
    (is
     (= {:parents
   ...
   (testing "OWL object properties"
    (is
     (=
      [{:inverse "http://www.co-ode.org/ontologies/pizza/pizza.owl#isToppingOf"
        :super
        ["http://www.co-ode.org/ontologies/pizza/pizza.owl#hasIngredient"]
        :type :oproperty
  ...
  (testing "Mike's annotations"
   (let [ontology-file (->> "Ontologies"
                            (io/file (io/resource "concepts+assertions"))
                            file-seq
     ...
     (is
      (=
       {:super
        ["http://purl.obolibrary.org/obo/CCP:subtractive_or_suppressive_process"]
        :type :class
        :iri {:fragment  "impairment"
              :namespace "http://purl.obolibrary.org/obo/CCP:"}
        :annotation
        [{:type :comment
          :literal
          {:value
           "disturb/disturbance/disturbances/disturbed/disturbing/disturbs, impair/impaired/impairing/impairs"
           :type :RDF_PLAIN_LITERAL}}]}
